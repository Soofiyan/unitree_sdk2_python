    ...
    def get_transform(self):
        try:
            trans: TransformStamped = self.tf_buffer.lookup_transform(
                'libsurvive_frame',  # Parent frame
                'LHB-E094AD5C',      # Child frame
                rclpy.time.Time()
            )
            ...
            self.vive_rot = pin.Quaternion(quaternion.w, quaternion.x, quaternion.y, quaternion.z).toRotationMatrix().eulerAngles(2, 1, 0)
